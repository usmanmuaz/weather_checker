...
/// base : "stations"
/// main : {"temp":305.28,"feels_like":312.28,"temp_min":305.28,"temp_max":305.28,"pressure":1000,"humidity":68,"sea_level":1000,"grnd_level":944}
/// visibility : 10000
/// wind : {"speed":1.25,"deg":200,"gust":2.01}
/// clouds : {"all":67}
/// dt : 1689502717
/// sys : {"type":2,"id":2007435,"country":"PK","sunrise":1689466081,"sunset":1689517109}
/// timezone : 18000
/// id : 1162015
/// name : "Islamabad"
/// cod : 200

WeatherModelClass weatherModelClassFromJson(String str) => WeatherModelClass.fromJson(json.decode(str));
String weatherModelClassToJson(WeatherModelClass data) => json.encode(data.toJson());
class WeatherModelClass {
  ...
  WeatherModelClass.fromJson(dynamic json) {
  ...
  String? _name;
  num? _cod;
WeatherModelClass copyWith({  Coord? coord,
  List<Weather>? weather,
  String? base,
  Main? main,
  num? visibility,
  ...
  String? name,
  num? cod,
}) => WeatherModelClass(  coord: coord ?? _coord,
